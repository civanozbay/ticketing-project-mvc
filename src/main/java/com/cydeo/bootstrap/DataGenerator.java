...
@Component
public class DataGenerator implements CommandLineRunner { // whenever you start the application firstly this class will gonna run
    // if you want to initiate something you should use commandlinerunner
